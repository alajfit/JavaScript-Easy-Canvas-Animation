 ...
 * Runs an FPS counter if wantede using the initial variable and if an element with the id 'fps' is present
...
(function () {
    ...
    document.onreadystatechange = function () { // when document readt state changes
